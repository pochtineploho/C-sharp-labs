...
public class CashOutSuccessTest
{
    [Theory]
    [MemberData(nameof(Lab5TestDataGenerator.CashOutSuccessTestData), MemberType = typeof(Lab5TestDataGenerator))]
    public async Task TestGoodCashOut(long balance, long deposit)
    {
